...
?>
 ...
 <body>
    ...
    <form action="reporte-ruta-and.php">
        Genero
           <select name="genero">
       ...
       <input type="submit" value="Buscar con AND"> 
    ...
    <h1>Reporte Ruta- Búsqueda por AND Página 2</h1>
    <table border ="1">
        <tr>
            <td>
                Nombre cliente
