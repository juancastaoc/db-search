...
if (isset($_REQUEST ['genero'])){
    ...
    if ($genero !=""){
        if($where == ""){
           ...
           $where = "$where OR  cl.genero = '$genero'"; 
        }   
    }
}
...
?>
 ...
 <body>
    ...
    <form action="reporte-ruta-or.php">
        Genero
           <select name="genero">
       ...
       <input type="submit" value="Buscar con OR" name="button2">
    <hr>


    </form>

    <h1>Reporte Ruta- Búsqueda por OR - Página 3</h1>
    <table border ="1">
        <tr>
            <td>
                Nombre cliente
